...
neo4j-import --into dblp.db --nodes:Author "dblp_author-header.csv,dblp_author.csv" --nodes:Paper "dblp_papers-header.csv,dblp_papers.csv" --nodes:Institute "dblp_aff-header.csv,dblp_aff.csv" --relationships:References "dblp_ref-header.csv,dblp_ref.csv" --relationships:Affiliated "dblp_author2affiliation-header.csv,dblp_author2affiliation.csv" --ignore-empty-strings true --ignore-extra-columns true --bad-tolerance 1000000
